...
## Oppgavesett: Interaktiv Online CV Webapplikasjon: `React router dom V6`
...
**Link:** [React Router useParams](https://reactrouter.com/docs/en/v6/api#useparams)-e 
...
**Link:** [React Router useLocation](https://reactrouter.com/docs/en/v6/api#uselocation)-e 
...
**Forklaring:**
Rådene her er fokusert på optimalisering for å sikre at komponenter som konsumerer Contexts ikke blir re-rendret unødvendig, noe som kan påvirke ytelsen i en React-applikasjon.-e 
